...
void setupButtons() {
  ...
  menuButtons.add(new RectButton(width/4, height*13/20, width/3, width/6, #FFFFFF, #000000, 10, "Easy", easy));
  menuButtons.add(new RectButton(width*3/4, height*13/20, width/3, width/6, #FFFFFF, #000000, 10, "Medium", medium));
  menuButtons.add(new RectButton(width/2, height*35/40, width/3, width/6, #FFFFFF, #000000, 10, "Hard", hard));

  
  winButtons.add(new RectButton(width/2, height*7/10, width/3, width/6, #FFFFFF, #000000, 10, "Again", again));
  loseButtons.add(new RectButton(width/2, height*7/10, width/3, width/6, #FFFFFF, #000000, 10, "Again", again));
